                            ...
                            <tbody>
                                <c:forEach var="emp" items="${requestScope.ArrayEmpleados}">
                                    <tr>
                                        ...
                                        <td>
                                            <button class=" btn btn-circle btn-mn btn-primary" type="button" onclick="location.href = 'EmpleadoControllers?action=update&id=${emp.idEmpleado}'">
                                                <span class="fa fa-edit"></span>
                                            </button>
                                            <button class=" btn btn-circle btn-mn btn-danger" type="button" onclick="location.href = 'EmpleadoControllers?action=eliminar&id=${emp.idEmpleado}'">
