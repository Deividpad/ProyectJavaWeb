    ...
    <div class="sub-left-menu scroll">
        <ul class="nav nav-list">
            ...
            <li class="active ripple">
                <a class="tree-toggle nav-header"><span class="fa-home fa"></span> Empleados 
                    <span class="fa-angle-right fa right-arrow text-right"></span>
                </a>
                <ul class="nav nav-list tree">
                    <li><a href="${pageContext.request.servletContext.contextPath}/RegistrarEmpleado.jsp">Registrar Empleados</a></li>
                    <li><a href="EmpleadoControllers?action=admin">Administrar</a></li>
                </ul>
            </li>
            <li class="ripple">
